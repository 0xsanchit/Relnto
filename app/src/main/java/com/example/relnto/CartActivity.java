...
public class CartActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Cart> options =
                ...
                .setQuery(cartListRef.child("Admin View").child(firebaseAuth.getCurrentUser().getUid()).child("Products"),Cart.class).build();
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter
            ...
            public CartViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                ...
                View view = (View) LayoutInflater.from(parent.getContext()).inflate(R.layout.cart_items_layout,parent,false);
        ...
        ordersRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists())
                {
                    ...
                    {
                        txtTotalAmount.setText("Dear " + firebaseAuth.getCurrentUser().getEmail() + "\n order is shipped successfully.. ");
                        recyclerView.setVisibility(View.GONE);

                        txtMsg1.setVisibility(View.VISIBLE);
                        txtMsg1.setText("Your order has been successfully shipped. Soon you will received your order at your door step.");
